          ...
          rounded-xl text-white bg-[#5B112B] hover:scale-105 duration-100 pr-2"
                > 
                    ...
                    <div> 
                        ...
                        <button className=" mr-1 p-3  border-[#ED6361] bg-transparent rounded-md hover:scale-105 duration-300 hover:bg-[#ED6361] hover:border-rose-950" onClick={handleClick}>
                            <AiOutlineSearch
                                size={20}
                ...
                <h5 className="font-semibold mt-4 font-inter text-red-950 ">NB : autorisez votre position pour pouvoir effectuer une recherche par rayon. </h5>
            </div>
        </div>
